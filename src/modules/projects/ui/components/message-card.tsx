...
const AssistantMessage = ({
    ...
    return (
        <div className={cn("flex flex-col group px-2 pb-4", type == "ERROR" && "text-red-700 dark:text-red-500")}>
            <div className="flex tems-center gap-2 pl-2 mb-2">
                <Image
                    src="/logo.svg"
                    alt="logo"
                    width={18}
...
const FragemntCard = ({
    ...
    return (
        <button
            className={cn("flex items-start text-start gap-2 border rounded-lg bg-muted w-fit p-3 hover:bg-secondary transition-colors", isActiveFragment && "bg-primary text-primary-foreground border-primary hover:bg-foreground")}
